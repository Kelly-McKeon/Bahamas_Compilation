...
#### AM2
AM2_events5 = np.percentile(AM2_age_dist, 5, axis=0)
AM2_events95 = np.percentile(AM2_age_dist, 95, axis=0)
...
lowerr = AM2_events50 - AM2_events5
higherr = AM2_events95 - AM2_events50
xerr= np.stack((lowerr, higherr), axis=1)
xerr_AM2 = xerr.T


#### AM4
AM4_events5 = np.percentile(AM4_age_dist, 5, axis=0)
AM4_events95 = np.percentile(AM4_age_dist, 95, axis=0)
AM4_events50 = np.median(AM4_age_dist, axis=0)
#to plot error bars the error has to be in relation to the center value
#so subtract the median value from the percentiles to be able to plot percentiles w/error
lowerr = AM4_events50 - AM4_events5
higherr = AM4_events95 - AM4_events50
xerr= np.stack((lowerr, higherr), axis=1)
xerr_AM4 = xerr.T

#### AM5
AM5_events5 = np.percentile(AM5_age_dist, 5, axis=0)
AM5_events95 = np.percentile(AM5_age_dist, 95, axis=0)
AM5_events50 = np.median(AM5_age_dist, axis=0)
#to plot error bars the error has to be in relation to the center value
#so subtract the median value from the percentiles to be able to plot percentiles w/error
lowerr = AM5_events50 - AM5_events5
higherr = AM5_events95 - AM5_events50
xerr= np.stack((lowerr, higherr), axis=1)
xerr_AM5 = xerr.T

#### AM7
AM7_events5 = np.percentile(AM7_age_dist, 5, axis=0)
AM7_events95 = np.percentile(AM7_age_dist, 95, axis=0)
AM7_events50 = np.median(AM7_age_dist, axis=0)
#to plot error bars the error has to be in relation to the center value
#so subtract the median value from the percentiles to be able to plot percentiles w/error
lowerr = AM7_events50 - AM7_events5
higherr = AM7_events95 - AM7_events50
xerr= np.stack((lowerr, higherr), axis=1)
xerr_AM7 = xerr.T
...
sim_len = 4000
perc_thresh = 0.95
record_names = ["AM4", "AM5", "AM2", "AM7"] #sort by record length
...
np.savetxt(r"Compilation_Data/composite_dist.csv", composite_distributions, delimiter=',')
...
#### AM2
#percentiles
AM2_keepers5 = np.percentile(AM2_dist_keep, 5, axis=0)
AM2_keepers95 = np.percentile(AM2_dist_keep, 95, axis=0)
AM2_keepers50 = np.median(AM2_dist_keep, axis=0)
#errors
lowerr = AM2_keepers50 - AM2_keepers5
higherr = AM2_keepers95 - AM2_keepers50
xerr = np.stack((lowerr, higherr), axis=1)
xerr_AM2_keep = xerr.T

#### AM4
#percentiles
AM4_keepers5 = np.percentile(AM4_dist_keep, 5, axis=0)
AM4_keepers95 = np.percentile(AM4_dist_keep, 95, axis=0)
AM4_keepers50 = np.median(AM4_dist_keep, axis=0)
#errors
lowerr = AM4_keepers50 - AM4_keepers5
higherr = AM4_keepers95 - AM4_keepers50
xerr = np.stack((lowerr, higherr), axis=1)
xerr_AM4_keep = xerr.T

#### AM5
#percentiles
AM5_keepers5 = np.percentile(AM5_dist_keep, 5, axis=0)
AM5_keepers95 = np.percentile(AM5_dist_keep, 95, axis=0)
AM5_keepers50 = np.median(AM5_dist_keep, axis=0)
#errors
lowerr = AM5_keepers50 - AM5_keepers5
higherr = AM5_keepers95 - AM5_keepers50
xerr = np.stack((lowerr, higherr), axis=1)
xerr_AM5_keep = xerr.T

#### AM7
#percentiles
AM7_keepers5 = np.percentile(AM7_dist_keep, 5, axis=0)
AM7_keepers95 = np.percentile(AM7_dist_keep, 95, axis=0)
AM7_keepers50 = np.median(AM7_dist_keep, axis=0)
#errors
lowerr = AM7_keepers50 - AM7_keepers5
higherr = AM7_keepers95 - AM7_keepers50
xerr = np.stack((lowerr, higherr), axis=1)
...
ax.set_title('95% Threshold', fontsize=13)
...
np.savetxt(r"Compilation_Data/l_matrix_comp.csv", l_matrix_comp, delimiter=',')
...
flow = np.percentile(mean_rate_C[794:], 5)
fhigh = np.percentile(mean_rate_C[794:],95)
fstd = np.std(mean_rate_C)

#average storm frequency wallace AM4
fmean_wall = np.nanmean(pub_AM4_freq[:721])
flow_wall = np.nanpercentile(pub_AM4_freq[:721],5)
fhigh_wall = np.nanpercentile(pub_AM4_freq[:721],95)
fstd_wall = np.nanstd(pub_AM4_freq[:721])

#average storm frequency winkler AM stack
fmean_wink = np.nanmean(pub_AM_stack[:820])
flow_wink = np.nanpercentile(pub_AM_stack[:820],5)
fhigh_wink = np.nanpercentile(pub_AM_stack[:820],95)
