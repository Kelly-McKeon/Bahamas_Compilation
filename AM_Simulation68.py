...
for i in range(0, len(b1_stormyears)):
    b1_pert.append(int(np.random.uniform(b1_stormyears[i],3*dstd))) #save as integers
b1_pert=np.array(b1_pert)
#record 2
for i in range(0, len(b2_stormyears)):
    b2_pert.append(int(np.random.uniform(b2_stormyears[i],3*dstd))) #save as integers
b2_pert=np.array(b2_pert)
#record 3
for i in range(0, len(b3_stormyears)):
    b3_pert.append(int(np.random.uniform(b3_stormyears[i],3*dstd))) #save as integers
b3_pert=np.array(b3_pert)
#record 4
for i in range(0, len(b4_stormyears)):
    b4_pert.append(int(np.random.uniform(b4_stormyears[i],3*dstd))) #save as integers
...
b1_events16 = np.percentile(b1_pert_dist, 16, axis=0)
b1_events84 = np.percentile(b1_pert_dist, 84, axis=0)
#errors
lowerr = b1_events50 - b1_events16
higherr = b1_events84 - b1_events50
...
b2_events16 = np.percentile(b2_pert_dist, 16, axis=0)
b2_events84 = np.percentile(b2_pert_dist, 84, axis=0)
#errors
lowerr = b2_events50 - b2_events16
higherr = b2_events84 - b2_events50
xerr = np.stack((lowerr, higherr), axis=1)
xerr_b2 = xerr.T
...
b3_events16 = np.percentile(b3_pert_dist, 16, axis=0)
b3_events84 = np.percentile(b3_pert_dist, 84, axis=0)
#errors
lowerr = b3_events50 - b3_events16
higherr = b3_events84 - b3_events50
xerr = np.stack((lowerr, higherr), axis=1)
xerr_b3 = xerr.T
...
b4_events16 = np.percentile(b4_pert_dist, 16, axis=0)
b4_events84 = np.percentile(b4_pert_dist, 84, axis=0)
#errors
lowerr = b4_events50 - b4_events16
higherr = b4_events84 - b4_events50
xerr = np.stack((lowerr, higherr), axis=1)
xerr_b4 = xerr.T
...
#%% Determine Overlapping Event beds
start_cdf = time.time()
sim_len = 1000
perc_thresh = 0.68
...
# create mega list of all core medians
...
#### b1
#percentiles
b1_keepers16 = np.percentile(b1_dist_keep, 16, axis=0)
b1_keepers84 = np.percentile(b1_dist_keep, 84, axis=0)
b1_keepers50 = np.median(b1_dist_keep, axis=0)
#errors
lowerr = b1_keepers50 - b1_keepers16
higherr = b1_keepers84 - b1_keepers50
xerr = np.stack((lowerr, higherr), axis=1)
xerr_b1_keep = xerr.T

#### b2
#percentiles
b2_keepers16 = np.percentile(b2_dist_keep, 16, axis=0)
b2_keepers84 = np.percentile(b2_dist_keep, 84, axis=0)
b2_keepers50 = np.median(b2_dist_keep, axis=0)
#errors
lowerr = b2_keepers50 - b2_keepers16
higherr = b2_keepers84 - b2_keepers50
xerr = np.stack((lowerr, higherr), axis=1)
xerr_b2_keep = xerr.T

#### b3
#percentiles
b3_keepers16 = np.percentile(b3_dist_keep, 16, axis=0)
b3_keepers84 = np.percentile(b3_dist_keep, 84, axis=0)
b3_keepers50 = np.median(b3_dist_keep, axis=0)
#errors
lowerr = b3_keepers50 - b3_keepers16
higherr = b3_keepers84 - b3_keepers50
xerr = np.stack((lowerr, higherr), axis=1)
xerr_b3_keep = xerr.T

#### b4
#percentiles
b4_keepers16 = np.percentile(b4_dist_keep, 16, axis=0)
b4_keepers84 = np.percentile(b4_dist_keep, 84, axis=0)
b4_keepers50 = np.median(b4_dist_keep, axis=0)
#errors
lowerr = b4_keepers50 - b4_keepers16
higherr = b4_keepers84 - b4_keepers50
xerr = np.stack((lowerr, higherr), axis=1)
xerr_b4_keep = xerr.T
...
np.savetxt(r"Simulation_Data/Dep_Number68.csv", dif_deposit_number, delimiter=',')
np.savetxt(r"Simulation_Data/Dep_Perc68.csv", dif_deposit_perc, delimiter=',')
np.savetxt(r"Simulation_Data/RMSE_Timeseries68.csv", RMSE_timeseries, delimiter=',')
np.savetxt(r"Simulation_Data/RMSE_Simulated68.csv", RMSE_simulated, delimiter=',')
np.savetxt(r"Simulation_Data/RMSE_w2020_68.csv", RMSE_w2020, delimiter=',')
np.savetxt(r"Simulation_Data/RMSE_w2023_68.csv", RMSE_w2023, delimiter=',')
np.savetxt(r"Simulation_Data/RMSE_w2023c_68.csv", RMSE_w2023c, delimiter=',')
np.savetxt(r"Simulation_Data/RMSE_w2020_sim_68.csv", RMSE_w2020_sim, delimiter=',')
np.savetxt(r"Simulation_Data/RMSE_w2023_sim_68.csv", RMSE_w2023_sim, delimiter=',')
np.savetxt(r"Simulation_Data/RMSE_w2023c_sim_68.csv", RMSE_w2023c_sim, delimiter=',')
np.savetxt(r"Simulation_Data/FakeR_Outside68.csv", faker_outside, delimiter=',')
np.savetxt(r"Simulation_Data/Lsim_Outside68.csv", lsim_outside, delimiter=',')
