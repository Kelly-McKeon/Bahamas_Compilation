...
plt.ylabel('counts')
plt.title('AM2 Coarse Distribution')
plt.show()
...
ax.set_title('slump threshold (AM2)')
ax.legend()
plt.show()
...
ax1.set_title('Coarse Anomaly (AM2)')
ax1.legend()
ax1.set_xlim(0,25)
...
# Here we will use the median + 1sd of the entire % coarse anomaly timeseries (2.47, close to the paper)
...
plt.show()
plt.xlim(0,30)
plt.suptitle('AM2 Events, % coarse')     
...
plt.suptitle('AM2 Events')       


#%% Get Published Event Depths
published = np.genfromtxt(r"AM2_CoreData/AM2_pubFreq.csv", delimiter=",", skip_header=1)
...
np.savetxt(r"AM2_CoreData/threshold.csv", mov_anomaly, delimiter=',')
np.savetxt(r"AM2_CoreData/moving_mean.csv", gs63_mov, delimiter=',')
np.savetxt(r"AM2_CoreData/median_ages.csv", ages_med, delimiter=',')
np.savetxt(r"AM2_CoreData/event_times.csv", event_time_array, delimiter=',')
np.savetxt(r"AM2_CoreData/event_gs.csv", event_gs_array, delimiter=',')    
np.savetxt(r"AM2_CoreData/event_times_pub.csv", event_time_pub, delimiter=',')  
np.savetxt(r"AM2_CoreData/event_gs_pub.csv", event_gs_pub, delimiter=',')      

## event depths to export to R
np.savetxt(r"AM2_CoreData/event_depth.csv", event_depth_array, delimiter=',')
np.savetxt(r"AM2_CoreData/event_depth_pub.csv", event_depth_pub, delimiter=',')
...
# save storm years
np.savetxt(r"AM2_CoreData/storm_years.csv", strmyrs, delimiter=',')
np.savetxt(r"AM2_CoreData/all_years.csv", allyrs, delimiter=',')
...
ax.set_title('Rate Parameter with Age Uncertainty (AM2)')


#%% Save kernel data for comparison later 
np.savetxt(r"AM2_CoreData/l_matrix.csv", l_matrix, delimiter=',')
np.savetxt(r"AM2_CoreData/event_matrix_bool.csv", event_matrix_bool, delimiter=',')
